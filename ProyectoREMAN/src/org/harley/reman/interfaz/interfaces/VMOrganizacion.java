 ...
 * @author User
 */
public class VMOrganizacion extends javax.swing.JFrame {

    /**
     * Creates new form VOrganizacion
     */
    public VMOrganizacion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VMOrganizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VMOrganizacion().setVisible(true);
            }
        });
    }
