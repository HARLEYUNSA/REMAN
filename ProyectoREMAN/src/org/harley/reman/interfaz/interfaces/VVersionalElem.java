 ...
 * @author User
 */
public class VVersionalElem extends javax.swing.JFrame {

    /**
     * Creates new form VVersionalElem
     */
    public VVersionalElem() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VVersionalElem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VVersionalElem().setVisible(true);
            }
        });
    }
