...
public class VEVersionarRnf extends JDialog {
    ...
    public VEVersionarRnf(JFrame padre, Sistema sysReman, String rnfCod, 
            String rnfNom, String rnfVer, String rnfTip, String rnfObj,
            String rnfFec, String rnfFueNom, String rnfFueCar, String rnfFueTip,
        ...
        try {
            historic = sysReman.getHist(Sistema.LIB_RNF, rnfCod);
        ...
        if (ToolsInterface.verificarVersion(version)) {
            if (ToolsSystem.CompararVersiones(version, lastVersion)) {
                ...
                ToolsInterface.msjInfo(this, "Operacion Exitosa", "El requisito"
                        + "no funcional se versiono correctamente");
                flagOk = true;
                this.dispose();
            } else {
    ...
    private void versionar(String verVer, String verFec, String verEsp, 
            String verRazCam) {
        sysReman.versionarReqNoFuncional(verVer, verFec, verEsp, verRazCam, 
                rnfCod, rnfNom, rnfVer, rnfTip, rnfObj, rnfFec, rnfFueNom,
                rnfFueCar, rnfFueTip, rnfEspNom, rnfEspEsp, rnfEspExp, 
                rnfEspCar, rnfDep, rnfDes, rnfObs);
    }
