...
import org.harley.reman.sistema.ProyectTeam;
 ...
 * @author Joel Mendoza
 */
public class VMEspecialista extends JDialog {
    ...
    public VMEspecialista(JFrame padre, Sistema sysReman, String codPyt) {
        super(padre, true);
        initComponents();
        ...
        try {
            ...
            txtFEmail.setText(myPyt.getPytCor());
            txtFComentario.setText(myPyt.getPytCom());
            flagLoadOk = true;
        } catch (Exception e) {;
            flagLoadOk = false;
        }
    ...
    private void btnFGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFGuardarActionPerformed
        boolean error = false;
        String pytCod = txtFCodigo.getText();
        ...
        if (!error) {
            sysReman.modificarProyectTeam(pytCod, pytNom, pytOrg, pytEsp, pytExp, pytCar, pytCor, pytCom);
            flagSetOk = true;
            ToolsInterface.msjInfo(this, "Operacion Exitosa", "El especialista "
                    + pytNom + " fue modificado satisfactoriamente.");
            this.dispose();
        } else {
