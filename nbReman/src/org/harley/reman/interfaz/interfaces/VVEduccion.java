 ...
 * @author Joel Mendoza
 */
public class VVEduccion extends JDialog {
    ...
    public VVEduccion(JFrame padre, Sistema sysReman) {
        super(padre, true);
        initComponents();
    ...
    public void cargarDatos(String eduCod){
        try {
            //cargar de educcion
    ...
    private void initComponents() {
        ...
        txtEDNombre.setEditable(false);

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel12.setText("Código");

        txtEDTipo.setEditable(false);
        ...
        txtEDVersion.setEditable(false);
        ...
        txtEDObjetivo.setEditable(false);
        ...
        txtEDDescripcion.setEditable(false);
        ...
        cmbEDEspecialista.setEnabled(false);
